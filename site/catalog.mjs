...
export const plugins = [
  ...
  },
  {
    ...
    summary: 'The Codex-native plugin is in development on the codex-native-plugin branch. It packages all 18 skills as isolated, plugin-qualified adapters, backed by deterministic coordination, pinned codex exec contracts, durable checkpoints, new-session discovery, and reproducible install verification — built from that branch, not yet shipped on main.',
    install: [
    ...
    caveats: [
      'Work in progress: the plugin lives on the codex-native-plugin branch, not on main.',
      'Check out that branch and build the v0.1.0-dev marketplace artifact from source before adding it to Codex.',
      'Start a new Codex session after installation; running sessions do not discover newly added skills.',
      'The source-built artifact does not bundle the repository-level Codex hook wiring.',
    ],
    limitations: [
      'Work in progress: the plugin lives on the codex-native-plugin branch, not on main.',
      'Check out that branch and build the v0.1.0-dev marketplace artifact from source before adding it to Codex.',
