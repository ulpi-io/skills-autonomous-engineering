...
export const plugins = [
  ...
  },
  {
    ...
    shipped: false,
    headline: 'The same bounded engineering contracts, being molded around Codex-native execution.',
    summary: 'The universal SKILL.md pack works with Codex through skills.sh today. A native Codex plugin—with isolated Codex adapters, deterministic coordination, hook integration, and install verification—is in development and is not yet presented as shipped.',
    install: [
      'npx skills add https://github.com/ulpi-io/skills-autonomous-engineering',
      'npx skills add https://github.com/ulpi-io/skills-autonomous-engineering --skill <skill-name>',
    ],
    installCommands: [
      'npx skills add https://github.com/ulpi-io/skills-autonomous-engineering',
      'npx skills add https://github.com/ulpi-io/skills-autonomous-engineering --skill <skill-name>',
    ...
    capabilities: [
      'All 18 universal skills available through skills.sh today',
      'Native SKILL.md name and description routing',
      'Codex-tuned adapters and deterministic coordinator planned for the plugin release',
      'Codex hook, goal, subagent, worktree, and automation integration in development',
      'Real isolated install and invocation smoke gate required before release',
    ],
    caveats: [
      'The native Codex plugin package is preview work, not currently installable.',
      'Do not use a future marketplace command until the package passes its real Codex smoke gate.',
      'Claude-specific Workflow, memory, routine, and slash-command behavior is not claimed as universal.',
    ],
    limitations: [
      'The native Codex plugin package is preview work, not currently installable.',
      'Do not use a future marketplace command until the package passes its real Codex smoke gate.',
